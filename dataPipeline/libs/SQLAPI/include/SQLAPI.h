...
enum eSAClient
{
	...
	SA_Client_Last = SA_OLEDB_Client, //!< Special value for enumerations
...
public:
	...
	//! Destroys the result set opened with the specified SACommand object.
	void UnExecute() SQLAPI_THROW(SAException);
...
class SQLAPI_API SAValueRead
{
	...
	friend class IoledbCursor;
	friend class IoledbSequentialStream;
...
SQLAPI_API SAErrorClass_t sqlapi_unexecute(SACommand* cmd, SAException* err);
